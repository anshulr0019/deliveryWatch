  ...
  return (
    <section id="check" className="relative mx-auto w-full max-w-6xl scroll-mt-24 px-4 sm:px-6">
      <SpotlightCard className="p-1" borderGlowColor="rgba(200, 169, 110, 0.5)">
        <div className="rounded-[14px] bg-[#0B0D12]/80 p-6 sm:p-10">
          ...
          {result && (
            <div id="scan-result" className="fade-up mt-10 scroll-mt-28">
              <div className="grid items-center gap-8 lg:grid-cols-[auto_1fr]">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted">
                    <span className="text-white">{result.tier}</span> · Estimated inbox placement <span className="text-gold-light">{result.inboxProbability}%</span> · Scanned in{" "}
